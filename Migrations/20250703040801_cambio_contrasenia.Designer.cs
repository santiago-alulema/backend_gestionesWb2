...
namespace gestiones_backend.Migrations
{
    ...
    [Migration("20250703040801_cambio_contrasenia")]
    partial class cambio_contrasenia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gestiones_backend.Entity.CompromisosPago", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdCompromiso"));
            ...
            modelBuilder.Entity("gestiones_backend.Entity.DeudorTelefono", b =>
                {
                    b.Property<int>("IdDeudorTelefonos")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id_deudor_telefonos");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdDeudorTelefonos"));
            ...
            modelBuilder.Entity("gestiones_backend.Entity.Deudore", b =>
                {
                    b.Property<string>("IdDeudor")
                        .HasMaxLength(13)
                        .HasColumnType("character varying(13)")
            ...
            modelBuilder.Entity("gestiones_backend.Entity.TiposGestion", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IdTipoGestion"));
            ...
            modelBuilder.Entity("gestiones_backend.Entity.ConsultasExterna", b =>
                {
                    b.HasOne("gestiones_backend.Entity.Deudore", "IdDeudorNavigation")
                        .WithMany()
