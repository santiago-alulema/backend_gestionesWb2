    ...
    public class ConfigDeudasCliente
    {
        public static void Register(TypeAdapterConfig config)
        {
            config.NewConfig<Deuda, DeudasClienteOutDTO>()
                ...
                // 👇 Navegaciones NULL-SAFE (solo una vez c/u)
                .Map(d => d.Nombre,
                     s => s.IdDeudorNavigation != null
                            ? s.IdDeudorNavigation.Nombre
                            : null)

                .Map(d => d.Telefono,
                     s => s.IdDeudorNavigation != null && s.IdDeudorNavigation.Telefono != null
                            ? s.IdDeudorNavigation.Telefono
                            : string.Empty)

                .Map(d => d.Email,
                     s => s.IdDeudorNavigation != null && s.IdDeudorNavigation.Correo != null
                            ? s.IdDeudorNavigation.Correo
                            : string.Empty)

                // Campo con typo en el DTO
